...
import {
  IEquipmentChunkInfo,
  IEquipmentOrderInfo, IEquipmentPlateInfo, IEquipmentTaskInfo, IEquipmentWorkingInfo,
...
export default () => {
  const OrderInfo: IEquipmentOrderInfo = {
    ID: 'ID',
    ServerName: '名片之家',
  ...
  const Working: IEquipmentWorkingInfo = {
    ID: '123222',
    WorkingID: '123',
    WorkingName: '覆膜',
    TargetID: '234',
