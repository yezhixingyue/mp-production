  ...
  children: [
    {
      ...
      meta: {
        ...
        PermissionInfo: ['PermissionRequisition', 'HavePomission'],
      },
    ...
    },
    {
      ...
      meta: {
        ...
        PermissionInfo: ['PermissionStorage', 'HavePomission'],
      },
...

    {
      ...
      meta: {
        ...
        PermissionInfo: ['PermissionInOutStored', 'HavePomission'],
      },
    ...
    // 供应商
    {
      ...
      meta: {
        ...
        prevPage: 'materialClassifyManage',
        PermissionInfo: ['PermissionSupplier', 'HavePomission'],
      },
    ...
    },
    {
      ...
      meta: {
        ...
        prevPage: 'materialClassifyManage',
        PermissionInfo: ['PermissionWarehouse', 'HavePomission'],
      },
