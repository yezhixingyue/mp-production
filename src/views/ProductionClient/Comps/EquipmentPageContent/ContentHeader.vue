  ...
  <header class="mp-client-header">
    ...
    <div class="c">
      <template v-if="curActiveInstance && curActiveInstance.loginData.token">
        <span class="pink-span" @click="onEquipmentStopClick"
         :class="{'v-hide':curActiveInstance.Equipment.Status===EquipmentStatusEnum.failure}">机器报停</span>
    ...
    .c {
      ...
      > span {
        ...
        &.pink-span {
          ...
          &:active {
            color: darken($color: #ff0000, $amount: 5);
          }
          &.v-hide {
            visibility: hidden;
          }
