<template>
  ...
  <p class="btn-box" v-show="curInstance.ErrorInfo">
    <el-button type="primary" class="gradient" @click="onClick">恢复生产</el-button>
  </p>

  <!-- 待转换列表 -->
  <TaskListTable v-if="curInstance.ErrorInfo?.TaskList" :TaskList="curInstance.ErrorInfo.TaskList" isError />
</template>
