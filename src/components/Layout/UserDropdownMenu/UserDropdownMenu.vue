    ...
    <el-dropdown trigger="click">
      ...
      <template #dropdown>
        <el-dropdown-menu class="mp-erp-user-drop-down-wrap">
          ...
          <el-dropdown-item @click="onMenuClick('ManualOrder')"><i class="icon-header-03 iconfont"></i> 手动下单</el-dropdown-item>
          <el-dropdown-item @click="onMenuClick('ExternalReceiveManage')"><i class="icon-daiwaixie iconfont scale-8"
