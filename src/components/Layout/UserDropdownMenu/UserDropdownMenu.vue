    ...
    <el-dropdown trigger="click" placement="bottom-end" :show-arrow="false">
      ...
      <template #dropdown>
        <el-dropdown-menu class="mp-erp-user-drop-down-wrap">
          ...
          <el-dropdown-item v-if="user?.PermissionList.PermissionPrintExpress.HavePomission"
           @click="onLinkMenuClick('pack')"><i class="icon-dayinji iconfont scale-10"
            style="position: relative;right: 1px;"></i> 打包机台</el-dropdown-item>
